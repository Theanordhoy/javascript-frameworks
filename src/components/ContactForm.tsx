  ...
  return (
    <div>
      ...
      <form
        ...
        className="mx-auto max-w-3xl border border-gray-200 rounded-lg px-6 py-8 shadow-md mt-10 bg-white"
      >
        ...
        <div className="flex flex-col gap-4 mx-auto max-w-lg">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="border border-gray-400 rounded-lg p-2 shadow-md"
            />
            {nameError && (
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="subject" className="pl-1">
              Subject *
            </label>
            <input
              id="subject"
          ...
          <div>
            <button
              type="submit"
              className="border border-white bg-black hover:bg-gray-900 text-lg text-white font-semibold rounded-lg p-2 w-full my-5 cursor-pointer"
            >
              Submit
            </button>
          </div>
